<script type='text/javascript'>
    ...
    $(document).ready(function() {
        ...
        if (isMobile.Android()) {
            $('#openinapplink').attr('href', 'http://eddress.co/code/<?php if(isset($eddresss)){if ($eddresss->privacy != 2){echo $eddresss->privateCode;}else{echo $eddresss->code;}}?>');
        }else if (isMobile.iOS()) {
            $('#openinapplink').attr('href', 'eddress://?code=<?php if(isset($eddresss)){if ($eddresss->privacy != 2){echo $eddresss->privateCode;}else{echo $eddresss->code;}}?>');
        } else {
            $('#openinapplink').attr('href', 'eddress://?code=<?php if(isset($eddresss)){if ($eddresss->privacy != 2){echo $eddresss->privateCode;}else{echo $eddresss->code;}}?>');
        }
...
<nav class="navbar navbar-default navbar-fixed-top top-bar">
    <div class="navbar-header">
        ...
        <div id="bar-center">
            ...
            <div id="openinapp" class="openinapp hidden">
                <div class="details_openinapp"><a id="openinapplink" class="btn btn-default navbar-btn" type="button">Open in App</a></div>
            </div>
        </div>
    </div>
    ...
    <div class="collapse navbar-collapse top-bar-section" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="hidden-xs"><button type="button" id="store_btn" class="btn btn-default navbar-btn" style="letter-spacing: 1px;font-size: 12px;">GET THE APP</button></li>
            <li class="visible-xs">
